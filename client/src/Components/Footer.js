                ...
                <div className="container">
                    <div className="row py-4 d-flex justify-content-center align-items-center">
                        <div className="col-md-6 col-lg-5 text-center footer-text text-white">
                            Check out our <a href="https://github.com/Sri-Krishna-V/SignVani" className='footer-link' target="_blank" rel="noopener noreferrer">Github repo</a> for more information!
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="container text-md-left mt-5">
                    <div className="row mt-3">
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                            ...
                            <p><a href="https://github.com/Sri-Krishna-V/SignVani" className='footer-link' target="_blank" rel="noopener noreferrer">Github repo</a></p>
                        </div>

                        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                            <h6 className="text-uppercase font-weight-bold">Contact</h6>
                            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: '60px' }} />
                            <p><i className="fa fa-lg fa-home me-3 ms-0"></i><span className='footer-text'> Amrita Vishwa Vidhyapeetham, Coimbatore</span></p>
                            <p><i className="fa fa-user me-3 ms-0"></i><span className='footer-text'> Sri Krishna V </span> </p>
                            <p><i className="fa fa-user me-3 ms-0"></i><span className='footer-text'> Ezhil Adithya </span> </p>
                            <p><i className="fa fa-user me-3 ms-0"></i><span className='footer-text'> Siddharth S Nair</span> </p>
                        </div>
                    </div>
                </div>

                <div className="footer-copyright text-center py-3">© {new Date().getFullYear()} Copyright: Sri Krishna V</div>
            </div>
        </footer>
    )
}
